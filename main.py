...
from models.MSTSGM import build_net
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='MSTSGM', choices=['MSTSGM'], type=str)
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='results/MSTSGM/weights/Best.pkl')
