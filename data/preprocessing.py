...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--root_src', default='', type=str)
    parser.add_argument('--root_dst', default='', type=str)
    ...
    move(os.path.join(args.root_src, 'valid'), os.path.join(args.root_dst, 'valid'))